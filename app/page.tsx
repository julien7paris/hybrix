  ...
  return (
    <div className="text-center space-y-3 py-8">
      ...
      <p className="text-gray-600 max-w-2xl mx-auto">
        Missions réalisées par des binômes <b>IA + Expert Humain</b>. #Data & Analytics #Marketing & Growth #Design &
        Création #Juridique & Conformité #Support & Relation Client. Sécurisés via <b>Wallet Web3</b>.
      </p>
...
/* ---------- Suite : PostMission, Contracts, Page ---------- */
    ...
    >
      ...
      >
        ...
        <div className="text-xs text-white/60 mb-3">
          Prochain ID estimé: {String(nextId ?? "?")}
        </div>
        <button
      ...
      >
        ...
        <p className="text-xs text-white/60 mt-2">
          Pour la prod : passer en USDC + jalons multiples.
        </p>
      </motion.div>
    </motion.section>
  );
                  ...
                  {missions.map((m) => (
                    <div key={m.id} className="rounded-2xl border border-white/15 bg-white/5 p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="px-2 py-0.5 rounded-full border border-white/20 text-sm">
                          Budget {m.budget} €
                        </span>
                      </div>
